...
def banner():
    ...
    _____ *ily*ily*________*ily*ilyl*_____
___*ily* ___*ilyl*____*ily*___*ily*___
_*ily* ______*ily*_*ily*_______*ily*_
*ily* __________*ily*__________*ily*
*ily* ________________________*ily*
_*ily* ______*ï ??√? ?!*______*ily*_
__*ily* ____________________*ily*__
____*ily* ________________*ily*____
______*ily* ____________*ily*______
________*ily* ________ *ily*________
___*ily* ___*ily*____*ily*___*ily*___
_*ily* ______*ily*_*ily*_______*ily*_
*ily* __________*ily*__________*ily*
*ily* ________________________*ily*
_*ily* ______* ï ??√? ? !*______*ily*_
...
______*ily* ____________*ily*______
________*ily* ________ *ily*________
__________ *ily*____*ily*__________ 
____________’*ily*_*ily*____________
_______________*ily*_______________
...
time.sleep(1.5)
    ...
    print WW+"  |            👹👹👹FACEBOOK: Md Alfaj Hossain 👹👹👹            |"
    print Y+"  |             🔱🔱Free Fire: DRAlfajBoss🔱🔱              |"
    print GL+"  |👹👹👹👉👹👹👹👹👹👈👹👹👹👹|"
